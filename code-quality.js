...
console.log('Running "yarn eslint:fix" in client folder...');
...
console.log('Running "yarn eslint:fix" in server folder...');
...
console.log('Running "yarn eslint:fix" in shared folder...');
