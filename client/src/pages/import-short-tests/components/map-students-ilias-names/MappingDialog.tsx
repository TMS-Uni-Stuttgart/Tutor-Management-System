...
function MappingDialog({
    ...
    return (
        <Box display='flex' flexDirection='column'>
            <Typography>
                Wähle den/die Studierende/n aus, der zum Iliasnamen &ldquo;{iliasName}&rdquo;
                gehört. Beachte, dass diese Zuordnung nur für diesen Kurztest-Import gültig ist.
            </Typography>

            <Typography>
                Es werden nur die Studierenden in der Liste angezeigt, die zu keinem Iliasnamen
