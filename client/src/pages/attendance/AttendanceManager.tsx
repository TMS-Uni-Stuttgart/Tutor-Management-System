        ...
        .filter((stud) => {
            switch (filterOption) {
                ...
                case FilterOption.ACTIVE_AND_NO_SCHEIN_REQUIRED:
                    return (
                        stud.status === StudentStatus.ACTIVE ||
                        stud.status === StudentStatus.NO_SCHEIN_REQUIRED
                    );
                    ...
                    {date ? (
                        <TableWithPadding
                            ...
                            createRowFromItem={(student) => {
                                const attendance: IAttendance | undefined = student.getAttendance(
                                    date
                                );
                                ...
                                return (
                                    <StudentAttendanceRow
                                        ...
                                        onAttendanceSelection={(state) =>
                                            handleStudentAttendanceChange(student, state)
                                        }
