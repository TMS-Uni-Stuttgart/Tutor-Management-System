...
function FormikExerciseEditor({
    ...
    function handleCreateExercise(arrayHelpers: FieldArrayRenderProps) {
        return () => {
            const exercise: ExerciseFormExercise = getNewExercise(
                (exercises.length + 1).toString()
            );
                    ...
                    <div className={classes.infoBox}>
                        <Typography>
                            ...
                            {exercises.reduce((pts, ex) => {
                                ...
                                return Number.isNaN(pointsOfExercise)
                                    ? pts
                                    : pts + pointsOfExercise;
                            }, 0)}
                        </Typography>
                                ...
                                <div className={classes.subexerciseBox}>
                                    {ex.subexercises.map((_, subIdx) => (
                                        ...
                                        >
                                            ...
                                            <IconButton
                                                className={classes.deleteButton}
                                                onClick={handleDeleteSubexercise(
                                                    idx,
                                                    subIdx,
                                                    arrayHelpers
                                                )}
